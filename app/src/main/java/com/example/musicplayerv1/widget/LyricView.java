...
public class LyricView extends RelativeLayout implements View.OnTouchListener {
    ...
    public void setCurrentPosition(int position) {
        Log.e("change",String.valueOf(mPosition));
        doScroll(position);
        Log.e("change",String.valueOf(mPosition));
    }
    ...
    private void move(MotionEvent event) {
        ...
        Log.d("lyric","get"+String.valueOf(event.getY()));
        Log.d("lyric","down"+String.valueOf(downY));
        Log.d("lyric","down"+String.valueOf(mPosition));
        Log.d("lyric","hight"+String.valueOf(mTextView.getHeight()));
        Log.d("lyric","hight"+String.valueOf(mTextView.getTextSize()));
